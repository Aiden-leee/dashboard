...
export default {
	...
	methods: {
		createChart() {
			this.chartData = {
				data: {
					labels: ['Html&Css', 'Javascript', 'jQuery', 'Sass', 'Vue', 'React'],
					datasets: [
						{
							label: 'Skills',
							pointBackgroundColor: '#000',
							data: [95, 80, 85, 80, 75, 75],
							backgroundColor: [
								'rgba(0, 63, 86, 0.8)',
								'rgba(43, 133, 140, 0.8)',
								'rgba(116, 205, 182, 0.8)',
								'rgba(200, 255, 212, 0.8)',
								'rgba(255, 255, 202, 0.8)',
								'rgba(239, 225, 183, 0.8)',
							],
							borderColor: [
								'rgba(0, 63, 86, 1)',
								'rgba(43, 133, 140, 1)',
